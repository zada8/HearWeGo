...
public class FacilityActivity extends AppCompatActivity implements TMapGpsManager.onLocationChangedCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_facility4 = findViewById(R.id.facility4);
        button_facility5 = findViewById(R.id.facility5);
        button_facility6 = findViewById(R.id.facility6);
        button_facility7 = findViewById(R.id.facility7);
        button_facility8 = findViewById(R.id.facility8);
        button_facility9 = findViewById(R.id.facility9);
        button_facility10 = findViewById(R.id.facility10);
